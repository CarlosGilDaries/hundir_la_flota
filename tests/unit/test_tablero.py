...
def test_marcar_disparo(tablero, x, y, caracter):
...
def test_colocar_barco_manual(tablero, barco, x, y, esperado):
...
def test_colocar_barco_aleatorio(tablero, barcos):
...
def test_ver_tablero_muestra_barcos(tablero_con_barcos):
...
def test_ver_tablero_muestra_disparos(tablero_con_barcos):
...
def test_ver_tablero_rival_oculta_barcos(tablero_con_barcos):
...
def test_ver_tablero_rival_muestra_disparos(tablero_con_barcos):
...
def test_disparo_tocado(tablero_vacio):
...
def test_disparo_hundido(tablero_vacio):
...
def test_disparo_repetido(tablero_vacio):
...
def test_disparo_fuera_tablero(tablero, x, y):
...
def test_todos_colocados(tablero):
...
def test_todos_hundidos(tablero_vacio):
...
def test_get_todas_las_casillas(tablero_con_barcos):
...
def test_get_una_casilla(tablero_con_barcos):
